...
def plot_histogram(mean, sigma, n_samples, mode="Lognormal", color="black"):
    if mode == "Normal":
        ...
        op = ift.ExponentialTransform(key='Exponential for Histogram', mu=mean)
    ...
    plt.hist(op_samples, bins=200, label=label, histtype='step', facecolor='white', color=color)
