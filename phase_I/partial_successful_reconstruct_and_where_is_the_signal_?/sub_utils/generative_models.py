...
def generative_model_continuous_double_power_law(harmonic_space, apply_envelope=True,
    ...
    # exponent_clipper = ClipOperator(domain=alpha.target, clip_above=20, clip_below=-20)
    # alpha = exponent_clipper(alpha)
    # beta = exponent_clipper(beta)
