...
pipe_1_posterior_amplitude_spectrum = np.loadtxt("some_posterior_amp_spec.txt")
...
information_idx_1_2 = [(30, 47 * tmp, 12), (60, 0.5 * tmp, 25), (36 * 4, 3.49, 3), (60 * 4, 1.5, 5), (143, 0.38, 12), (331 * 4, 4.1, 4), (503 * 4, 6.7, 5), (995 * 4, 186 , 13), (1084 * 4, 8.3, 2), (1470 * 4, 129, 30), [1941 * 4, 1.18, 14]]
...
information_idx_1_2 = [(t[0], peak_amp_reduction * max(t[1], 0), t[2]) for t in information_idx_1_2]  # subtract threshhold in amplitudes

information_idx_1_2 = [t for t in information_idx_1_2 if t[1] != 0] # get rid of amplitudes that were 0 after subtracting the threshhold

# # np.savetxt("information_idcs_1_2.txt", information_idx_1_2)
# # print("\n Saved information_idcs_1_2.txt")
#
#
information_freq = [( f[t[0]],  t[1], t[2] * df) for t in information_idx_1_2]
